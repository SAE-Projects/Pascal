...
int main(void)
{
  ...
  DWT_Init();
  // 1. Start the sensor background interrupt immediately
  ...
  while (1)
  {
	...
	// Apply the normalization math to all 6 sensors
	IR_Apply_Calibration();

	// We print all 6 calibrated values (0-1000)
	// L: Left, LD: Left Diag, LF: Left Forward, RF: Right Forward, RD: Right Diag, R: Right
	sprintf(buffer,
	      "L:%4u LD:%4u LF:%4u | RF:%4u RD:%4u R:%4u\r\n",
	       my_mouse_sensors.left_cal,
	       my_mouse_sensors.left_diag_cal,
	       my_mouse_sensors.left_fwd_cal,
	       my_mouse_sensors.right_fwd_cal,
	       my_mouse_sensors.right_diag_cal,
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : LeftIR_OUT_Pin LeftForwardIR_OUT_Pin LeftDiagonalIR_OUT_Pin */
  GPIO_InitStruct.Pin = LeftIR_OUT_Pin|LeftForwardIR_OUT_Pin|LeftDiagonalIR_OUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : rightDiagonal_OUT_Pin RightForward_OUT_Pin RightIR_OUT_Pin BIN2_Pin
                           STBY_Pin */
  GPIO_InitStruct.Pin = rightDiagonal_OUT_Pin|RightForward_OUT_Pin|RightIR_OUT_Pin|BIN2_Pin
                          |STBY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
...
// Don't forget your __io_putchar function if you use printf!
