...
/* Private defines -----------------------------------------------------------*/
#define U3_B_Pin GPIO_PIN_0
#define U3_B_GPIO_Port GPIOA
#define U3_A_Pin GPIO_PIN_1
#define U3_A_GPIO_Port GPIOA
#define U2_B_Pin GPIO_PIN_6
#define U2_B_GPIO_Port GPIOA
#define U2_A_Pin GPIO_PIN_7
#define U2_A_GPIO_Port GPIOA
